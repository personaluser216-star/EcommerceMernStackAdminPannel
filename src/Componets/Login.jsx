  ...
  return (
    <div className='min-h-screen flex items-center justify-center w-full'>
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            <h1 className='text-2xl font-bold mb-4'>AdminPannel</h1>
...
<div className='mb-3 min-w-72'>
  ...
  />
                ...
                <button type='submit' className='mt-2 w-full py-2 px-4 rounded-md text-white bg-black hover:bg-gray-700'>Login</button>
            </form>
        </div>
    </div>
  )
